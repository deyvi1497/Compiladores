...
namespace Analizador_Lexico_Djp
{
    class Automata
    {
        ...
        public bool Reconoce(string texto, int iniToken, ref int i, int
        noAuto)
        {
            char c;
            _textoIma = texto;
            ...
            while (i <= _textoIma.Length)
                switch (_edoAct)
                {
                    ...
                    case 1:
                        ...
                        if ((lenguaje = "!\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~€‚ƒ„…†‡ˆ‰Š‹OEŽ''“”•–—˜™š›oežŸ ¡¢£¤¥¦§¨©ª«¬-®¯°±²³´μ¶·¸¹º»¼½¾¿\f").IndexOf(c)>=0) _edoAct=2; else
                {
                            i = iniToken;
                            return false;
                        }
                    ...
                    case 4:
                        ...
                        ((lenguaje = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz").IndexOf(c) >= 0) _edoAct = 4; else
                            ...
                            if ((lenguaje = "!\"#$%&\'()*+,-./:;<=>?@[\\]^`{|}~€‚ƒ„…†‡ˆ‰Š‹OEŽ‘’“”•–—˜™š›oežŸ ¡¢£¤¥¦§¨©ª«¬-®¯°±²³´μ¶·¸¹º»¼½¾¿\n\t\r\f").IndexOf(c)>=0)_edoAct=5; else
...
if ((lenguaje="0123456789").IndexOf(c)>=0)
_edoAct=7; else
if ((lenguaje=" !\"#$%&\'()*+,-./:;<=>? @ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€‚ƒ„…†‡ˆ‰Š‹OEŽ‘’“”•–—˜™š›oežŸ ¡¢£¤¥¦§¨©ª«¬-®¯°±²³´μ¶·¸¹º»¼½¾¿\n\t\r\f").IndexOf(c)>=0) _edoAct=8; else
{ i=iniToken;
return false; }
break;
case 8 : i--;
...
if ((lenguaje=" !#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€‚ƒ„…†‡ˆ‰Š‹OEŽ‘’“”•–—˜™š›oežŸ ¡¢£¤¥¦§¨©ª«¬-®¯°±²³´μ¶·¸¹º»¼½¾¿\n\t\r\f").IndexOf(c)>=0) _edoAct=12; else
{ i=iniToken;
return false; }
break;
case 13 : return true;
